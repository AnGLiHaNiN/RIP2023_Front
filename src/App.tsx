    ...
    <div className='d-flex flex-column vh-100'>
      ...
      <div className='container-xl d-flex flex-column px-2 px-sm-4 flex-grow-1'>
        <Routes>
          ...
          <Route path="/components-edit" element={<WithAuthCheck allowedRoles={[MODERATOR]}><ComponentsTable /></WithAuthCheck>} />
          <Route path="/components-edit/:component_id" element={<WithAuthCheck allowedRoles={[MODERATOR]}><ComponentEdit /></WithAuthCheck>} />
          ...
          <Route path="/profile" element={<WithAuthCheck allowedRoles={[CUSTOMER, MODERATOR]}><Profile /></WithAuthCheck>} />
        </Routes>
      </div>
    </div>
  )
