                            ...
                            <Card.Body>
                                ...
                                <ListGroup variant="flush">
                                    <ListGroup.Item>
                                        ...
                                        <Card.Text><b>Международное название:</b> {component.world_name}</Card.Text>
                                        <Card.Text><b>Количество:</b> {component.amount} мг</Card.Text>
                                        <Card.Text><b>Свойства:</b> {component.properties}</Card.Text>
                                    </ListGroup.Item>
                                </ListGroup>
